...
if (arrays_match_1.arraysMatch(arr, ['b', 'c', 1, 2, 3, 10, 20, 30, 'b', 'c', true, false, ['a', 'b'], 10, 20, 30,
...
if (arrays_match_1.arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', true, false, ['a', 'b'], 20, 30,
...
if (arrays_match_1.arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', false, ['a', 'b'], 20, 30,
...
if (arrays_match_1.arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', false, 20, 30,
...
if (arrays_match_1.arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', 20, 30, 'b', 'c', 1, 2, 3, 20, 30, 'b', 'c', 20, 30]))
    console.log('test 7 passed');
else
    console.log('test 7 FAILED');
// Test 8
removeAllOf_removeAllOfEach_1.removeAllOfEach(['b', 20, 2], arr);
if (arrays_match_1.arraysMatch(arr, ['c', 1, 3, 30, 'c', 30, 'c', 1, 3, 30, 'c', 30]))
