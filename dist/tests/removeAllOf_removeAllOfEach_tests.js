...
// Test 1
removeAllOf('a', arr);
if (arraysMatch(arr, ['b', 'c', 1, 2, 3, 10, 20, 30, 'b', 'c', true, false, ['a', 'b'], 10, 20, 30,
...
// Test 2
removeAllOf(10, arr);
if (arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', true, false, ['a', 'b'], 20, 30,
...
if (arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', false, ['a', 'b'], 20, 30,
...
// Test 4
removeAllOf(['a', 'b'], arr);
if (arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', false, 20, 30,
...
if (arraysMatch(arr, ['b', 'c', 1, 2, 3, 20, 30, 'b', 'c', 20, 30, 'b', 'c', 1, 2, 3, 20, 30, 'b', 'c', 20, 30]))
