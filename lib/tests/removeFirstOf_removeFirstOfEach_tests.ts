...
if (arraysMatch(
	arr,
	['b', 'c', 1, 2, 3, 10, 20, 30, 'a', 'b', 'c', true, false, ['a', 'b'], 10, 20, 30,
		'a', 'b', 'c', 1, 2, 3, 10, 20, ['a', 'b'], 30, 'a', 'b', 'c', 10, 20, 30, true, false]
))
...
if (arraysMatch(
	arr,
	['b', 'c', 1, 2, 3, 20, 30, 'a', 'b', 'c', true, false, ['a', 'b'], 10, 20, 30,
		'a', 'b', 'c', 1, 2, 3, 10, 20, ['a', 'b'], 30, 'a', 'b', 'c', 10, 20, 30, true, false]
))
...
if (arraysMatch(
	arr,
	['b', 'c', 1, 2, 3, 20, 30, 'a', 'b', 'c', false, ['a', 'b'], 10, 20, 30,
		'a', 'b', 'c', 1, 2, 3, 10, 20, ['a', 'b'], 30, 'a', 'b', 'c', 10, 20, 30, true, false]
))
...
if (arraysMatch(
	arr,
	['b', 'c', 1, 2, 3, 20, 30, 'a', 'b', 'c', false, 10, 20, 30,
		'a', 'b', 'c', 1, 2, 3, 10, 20, ['a', 'b'], 30, 'a', 'b', 'c', 10, 20, 30, true, false]
))
...
if (arraysMatch(
	arr,
	['b', 'c', 2, 3, 10, 20, 30, 'a', 'b', 'c', false, 10, 20, 30,
		'a', 'b', 'c', 1, 2, 3, 10, 20, ['a', 'b'], 30, 'a', 'b', 'c', 10, 20, 30, true, false]
))
